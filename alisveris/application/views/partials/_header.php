...
<?php endif; ?>
    <style>body {<?php echo $this->fonts->font_family; ?>} .product-item-options .item-option .icon-heart {color: #f15e4f !important;}  .btn-wishlist .icon-heart {color: #f15e4f !important;}</style>
