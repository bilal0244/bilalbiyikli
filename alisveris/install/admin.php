                        ...
                        <div class="messages">
                            <?php if (isset($error)) { ?>
                                <div class="alert alert-danger">
                                    <strong>Bağlantı sağlanamadı! Lütfen veritabanı kimlik bilgilerinizi kontrol edin.</strong>
                                </div>
                            <?php } ?>
                            <?php if (isset($success)) { ?>
                                <div class="alert alert-success">
                                    <strong>Kurulum tamamlanıyor ... Lütfen bekleyin!</strong>
                                </div>
                            <?php } ?>
                        </div>
                        <?php if (isset($success)) { ?>
                            ...
                            <div class="tab-1">
                                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab_1">
                                            <h1 class="step-title">Sistem Ayarları</h1>
