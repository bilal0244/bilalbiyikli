                ...
                <div class="col-sm-12">
                    ...
                    <div class="install-box">
                        ...
                        <div class="step-contents">
                            <div class="tab-1">
                                <h1 class="step-title">Sistem Gerekmsimleri</h1>
                                <div class="row">
                                    <div class="col-sm-11">
                                        <p>
                                ...
                                <div class="buttons">
                                    <a href="index.php?license_code=<?php echo $license_code; ?>&purchase_code=<?php echo $purchase_code; ?>" class="btn btn-success btn-custom pull-left">Geri</a>
                                    <a href="folder-permissions.php?license_code=<?php echo $license_code; ?>&purchase_code=<?php echo $purchase_code; ?>" class="btn btn-success btn-custom pull-right">İleri</a>
                                </div>
