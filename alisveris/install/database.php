...
if (isset($_POST["btn_install"])) {
    ...
    if ($core->validate_post($_POST) == true) {
        ...
        if ($database->create_database($_POST) == false) {
            $message = $core->show_message('error', "Veritabanı oluşturulamadı, lütfen veritabanı kimlik bilgilerinizi kontrol edin!");
                        ...
                        <div class="messages">
                            ...
                            <?php if (isset($installing)) { ?>
                                <div class="alert alert-success">
                                    <strong>Veritabanı oluşturuluyor. Lütfen bekle!</strong>
                                </div>
                            <?php } ?>
                        </div>
                        <?php if (isset($installing)) { ?>
                            ...
                            <div class="tab-1">
                                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab_1">
                                            <h1 class="step-title">Veritabanı</h1>
                                    ...
                                    <div class="buttons">
                                        <a href="folder-permissions.php?license_code=<?php echo $license_code; ?>&purchase_code=<?php echo $purchase_code; ?>" class="btn btn-success btn-custom pull-left">Geri</a>
                                        <button type="submit" name="btn_install" class="btn btn-success btn-custom pull-right">İleri</button>
                                    </div>
                                </form>
                            </div>
                        </div>
